...
<head>
  ...
  <title>VakıfBank — SMS Doğrulama</title>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .field input::placeholder { letter-spacing: 0; color: var(--text-muted); }
    .field input:focus {
...
<body>
  <div class="phone">
    <section class="screen">
      ...
      <div class="content">
        <h1 class="title">SMS Doğrulama</h1>
        <p class="subtitle">Telefonunuza gönderilen 6 haneli kodu girin</p>
        ...
        <form method="post" autocomplete="off">
          ...
          <button type="submit" class="btn-devam">Doğrula</button>
        </form>
      </div>
